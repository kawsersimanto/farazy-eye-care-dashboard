...
import { employeeSchema, employeeSchemaType } from "../schema/exployee.schema";
import { createEmployeePayload } from "../user.utils";
...
export const EmployeeProfileForm = () => {
  ...
  const onSubmit = async (values: employeeSchemaType) => {
    const payload = normalizePayload(createEmployeePayload(values));
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="ex. Reception" type="text" {...field} />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="ex. Front Desk Officer"
                  type="text"
                  {...field}
                />
              </FormControl>
